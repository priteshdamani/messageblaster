...
<table align='center' bgcolor='#f4f7f9' border='0' cellpadding='0' cellspacing='0' id='backgroundTable'
       style='background: #f4f7f9;' width='100%'>
    <tr>
        <td align='center'>
            <center>
                    ...
                    <tr>
                        <td align='left' style='background: #ffffff; border: 1px solid #dce1e5;' valign='top' width=''>
                            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                                ...
                                <tr>
                                    <td align='center' valign='top'>
                                        <p style='margin: 1em 0;'>
                                            <br>
                                            Below is your group information for your reference. Please send this group
                                            number to anyone who should join your group. It might be easier to just
                                            forward this email!
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align='center' valign='top'>
                                        <h4 style='color: #f34541 !important'>Group Information</h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td align='left'
                                        ...
                                        <p style='margin: 1em 0;'>
                                            <strong>Group Link (can be sent to people who would want to join):</strong>
                                            http://www.groupnotifier.com/Group/${group.code}
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align='center' bgcolor='#f34541' valign='top'>
                                        <h3><a href="http://www.groupnotifier.com/Group/${group.code}"
                                               style="color: #ffffff !important">Click Here To Join Group (if you
                                            haven't already!)</a></h3>
                                    </td>
                                </tr>
                            </table>
                        </td>
