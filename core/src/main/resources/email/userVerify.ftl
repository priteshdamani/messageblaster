                    ...
                    <tr>
                        <td align='left' style='background: #ffffff; border: 1px solid #dce1e5;' valign='top' width=''>
                            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                                <tr>
                                    <td align='center' valign='top'>
                                        <h2>Thank you for signing up with Group Notifier!</h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td align='center' valign='top'>
                                        <p style='margin: 1em 0;'>
                                            <br>
                                            Below is your login information for your reference. Please verify this email by clicking on the button below. You will not receive any emails or notifications from your groups until this step is done.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align='center' valign='top'>
                                        <h4 style='color: #f34541 !important'>Account confirmation</h4>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align='center' bgcolor='#f34541' valign='top'>
                                        <h3><a href="http://www.groupnotifier.com/VerifyEmail?code=${user.verificationRecord}&id=${user.id}" style="color: #ffffff !important">Click here to confirm your account</a></h3>
                                    </td>
                                </tr>
                            </table>
                        </td>
